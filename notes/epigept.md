...
- Core idea: The paper introduces EpiGePT, a transformer-based genomic language model that predicts epigenomic signals using DNA sequence, transcription factor activity, and chromatin interaction information.
...
- Data: The model is trained on large-scale epigenomic datasets, mainly from ENCODE.
...
- Model: The model contains four main modules.
...
- Conclusions: EpiGePT is a pretrained transformer model for epigenomics that integrates DNA sequence, transcription factor context, and 3D chromatin interactions.
